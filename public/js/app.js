...
var addApplicationButton = document.querySelector('.add-application-button');
var addApplicationForm = document.querySelector('.add-application-form');
var editApplicationForm = document.querySelector('.edit-application-form');
...
if (addApplicationButton) {
  addApplicationButton.addEventListener('click', function () {
    return showAddApplicationForm();
  }, false); // applicationSwal.fire({
...
var showAddApplicationForm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var _yield$applicationSwa, name;
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _yield$applicationSwa = _context.sent;
            name = _yield$applicationSwa.value;
            console.log(name); // applicationSwal.fire({
            //     title: 'Add Application',
            //     html:addApplicationForm.innerHTML,
            //     showCloseButton: true,
            //     showCancelButton: true,
  ...
  return function showAddApplicationForm() {
